...
QIWI_TOKEN = '29d69d6ac5850a903f64840f328c5eca'
QIWI_ACCOUNT = '+79198448283'
...
async def proverka_balans(call: types.callback_query):
    ...
    for i in range(len(req['data'])):
            if str(req['data'][i]['comment']) in text:
                summa = req['data'][i]['sum']['amount']
                await bot.send_message(call.message.chat.id, 'Оплата успешна')
